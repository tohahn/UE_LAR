...
def plot_alignment(time_series_1, time_series_2, alignment):
    ...
    pylab.plot(warp(time_series_1, time_series_2, alignment)[0,:], 'y',
               label="a(ts1)", lw=3, alpha=0.5)
    pylab.fill_between(range(time_series_1.shape[1]),
                       time_series_2[0,:],
                       warp(time_series_1, time_series_2, alignment)[0,:],
